...
type Config struct {
	...
	GoogleAndroidClientID string `mapstructure:"ANDROID_CLIENT_ID"`
	GoogleIOSClientID     string `mapstructure:"IOS_CLIENT_ID"`
	GoogleExpoClientID    string `mapstructure:"EXPO_CLIENT_ID"`
